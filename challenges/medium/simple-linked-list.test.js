...
describe("Simple Linked List", () => {
  ...
  test("items are stacked", () => {
    ...
    expect(list.getHead().datum()).toBe(2);
    expect(list.getHead().next().datum()).toBe(1);
  });
  ...
  test("from a: 2 element array", () => {
    ...
    expect(list.size()).toBe(2);
    expect(list.getHead().datum()).toBe(1);
    expect(list.getHead().next().datum()).toBe(2);
  });
  ...
  test("from a: 10 item array", () => {
    ...
    expect(list.size()).toBe(10);
    expect(list.peek()).toBe(1);
    expect(list.getHead().next().next().next().next()
  ...
  test("reverse 2 element list", () => {
    ...
    expect(reversedList.getHead().next().datum()).toBe(1);
    expect(reversedList.getHead().next().isTail()).toBe(true);
  });
